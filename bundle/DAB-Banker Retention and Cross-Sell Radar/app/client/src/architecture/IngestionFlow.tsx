  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-3 leading-relaxed">
        Core banking, card, and payroll feeds flow through{' '}
        <b className="text-foreground">Lakeflow Connect</b>, the{' '}
        <b className="text-foreground">SDP pipeline</b>, and{' '}
      ...
      <div className="flex justify-center" style={{ marginBottom: 38 }}>
        <div className="inline-flex items-start" style={{ gap: 2 }}>
          <Stage bare icon={<DataEventsIcon />} name="Feeds" sub="core · card · payroll" />
          <Connector />
          <Stage
            icon={
