/**
 * PlatformDiagram — the "Running Meridian's Retention & Cross-Sell Radar on
 * the Databricks Platform" panel that sits on top of the /platform page. Mirrors the
...
export function PlatformDiagram() {
  ...
  return (
    <section className="pd-root" aria-label="Meridian Bank on the Databricks Platform">
      <style>{CSS}</style>
      <div className="pd-wrap">
        <div className="pd-hero">
          <div className="pd-brand">Databricks Platform</div>
          <div className="pd-kick">Meridian Bank · Retention & Cross-Sell Radar</div>
          <h2>
            Running the Retention & Cross-Sell Radar on the{' '}
        ...
        <div className="pd-plat">
          ...
          >
            <Prod
              ...
              sub="This app — RM queue, agent, offers, all in one place"
            />
            <Prod
              href={href(R.dashboard.url)}
              icon={<AIBIIcon />}
              title="AI/BI Dashboard"
              sub="At-risk cohort + cross-sell opportunity, by segment & branch"
            />
          </Row>
          ...
          >
            ...
            <div className="pd-prod">
              ...
              <span className="pd-tx">
                ...
                <span className="pd-sub">"Which accounts are drifting, and why?"</span>
              </span>
            </div>
            {/* Single-agent, Genie-backed app: the in-app assistant reasons
                over Genie + writes the RM Radar in Lakebase. No MAS. */}
            <Prod
              href={href(R.app.url)}
              icon={<AgentsIcon />}
              title="In-app assistant"
              sub="Investigate the drift, draft retention + cross-sell offers, commit on approval"
            />
          </Row>
          ...
          >
            <Prod
              ...
              icon={<UCIcon />}
              title="Unity Catalog"
              sub="solution_builder.demo_banker_retention… — PII masked to each RM's role"
            />
            <Prod
            ...
            <div className="pd-story">
              ...
              <div className="pd-fork-dest">
                ...
                <Prod
                  ...
                  icon={<LakebaseIcon />}
                  title="Lakebase"
                  sub="The RM Radar reads/writes offers live · branch on reset"
                />
              </div>
            </div>
          </Row>
        ...
        <div className="pd-flows">
          ...
          <span className="pd-zb" title="Lakeflow Connect · managed ingest">
            <ZerobusBolt />Lakeflow Connect · managed ingest
          </span>
        </div>
        ...
        <div className="pd-sources">
          ...
          <div className="pd-src">
            ...
            <span className="pd-tx"><b>Card system</b><span>transactions · spend</span></span>
          </div>
          <div className="pd-src">
            <span className="pd-tile"><SrcIcon d={SRC.odds} /></span>
            <span className="pd-tx"><b>Payroll feed</b><span>direct-deposit credits</span></span>
          </div>
          <div className="pd-src">
            <span className="pd-tile"><SrcIcon d={SRC.pdf} /></span>
            <span className="pd-tx"><b>Customer profiles</b><span>segment · branch · RM</span></span>
          </div>
        </div>
