      ...
      <div className="dx-mas-stage" aria-hidden>
        ...
        <div className="dx-mas-question">
          ...
          <span className="dx-mas-question-text">
            <span className="dx-mas-question-typed">Which accounts are drifting?</span>
        ...
        <div className="dx-mas-agents">
          <div className="dx-mas-agent dx-mas-agent-1">
            ...
            <span className="dx-mas-agent-task">querying the book of business…</span>
          </div>
          <div className="dx-mas-agent dx-mas-agent-2">
            ...
            <span className="dx-mas-agent-task">searching retention playbook…</span>
          </div>
          <div className="dx-mas-agent dx-mas-agent-3">
            ...
            <span className="dx-mas-agent-task">parsing account signals…</span>
          </div>
        </div>
